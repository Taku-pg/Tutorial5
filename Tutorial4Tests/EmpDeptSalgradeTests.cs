...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => e.DeptNo == depts.Where(d=>d.Loc=="CHICAGO").Select(d=> d.DeptNo).First()).ToList(); 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e,d) => (e.EName,d.DName)); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e=>e.Comm is not null).Select(e=>(e.EName,e.Comm)).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Select(e =>
            new { e.EName , Grade = grades.SingleOrDefault(g => e.Sal >= g.Losal && e.Sal <= g.Hisal)?.Grade});
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e=>e.Sal>emps.Where(e2=>e2.DeptNo==e.DeptNo).Average(e2=>e2.Sal)).Select(e=>e.EName); 
